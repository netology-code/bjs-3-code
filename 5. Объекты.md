...
Можно реализовать метод, который смогут использовать все инстансы(экземпляры).
Мы должны поместить функцию в свойство `prototype` функции конструктора
...
Сейчас данный функционал в 99% случаев реализуется с помощью классов, в которые встроено удобное наследование и другие полезные фишки.
